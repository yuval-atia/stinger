...
import { deduplicateLines } from '../../utils/textTools';
...
function DeduplicateLinesCard({ toolSlug }) {
  ...
  return (
    <ToolCard title="Deduplicate Lines" toolSlug={toolSlug} icon={DeduplicateIcon} info={{
...
export default DeduplicateLinesCard;
